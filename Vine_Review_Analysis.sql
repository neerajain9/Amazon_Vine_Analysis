...
SELECT count(*) FROM vine_gt_50pct;
...
UPDATE
analysis_table 
SET five_star_reviews =(SELECT count(*) FROM vine_gt_50pct WHERE star_rating = 5);
...
UPDATE
analysis_table
-- SET pct_five_star_reviews_Y =((SELECT count(*) FROM vine_gt_50pct WHERE star_rating = 5 AND vine = 'Y')/CAST(total_reviews AS FLOAT));
SET pct_five_star_reviews_Y =((SELECT count(*) FROM vine_gt_50pct WHERE star_rating = 5 AND vine = 'Y')/CAST((SELECT count(*) FROM vine_gt_50pct WHERE vine = 'Y') AS FLOAT));
...
UPDATE
analysis_table
-- SET pct_five_star_reviews_N =((SELECT count(*) FROM vine_gt_50pct WHERE star_rating = 5 AND vine = 'N')/CAST(total_reviews AS FLOAT));
SET pct_five_star_reviews_N =((SELECT count(*) FROM vine_gt_50pct WHERE star_rating = 5 AND vine = 'N')/CAST((SELECT count(*) FROM vine_gt_50pct WHERE vine = 'N') AS FLOAT));
